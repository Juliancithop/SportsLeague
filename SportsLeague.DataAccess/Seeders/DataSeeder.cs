...
public static class DataSeeder
{
    public static async Task SeedAsync(LeagueDbContext context)
    {
        ...
        var teams = new List<Team>
        {
            ...
            new() { Name="Alianza Valledupar FC", City="Valledupar", Stadium="Armando Maestre", FoundedDate= new DateTime(2024, 1, 16) },
            new() { Name="Fortaleza FC", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate= new DateTime(2010, 11, 15) },
            ...
            new() { Name="Internacional de Bogotá", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate= new DateTime(2023, 10, 5) }
        };
